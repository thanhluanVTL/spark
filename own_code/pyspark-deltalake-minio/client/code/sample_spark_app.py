...
# conf.set("spark.jars", '/home/code/hadoop-aws-3.3.1.jar, /home/code/delta-core_2.12-2.1.0.jar, /home/code/delta-storage-2.1.0.jar, /home/code/aws-java-sdk-bundle-1.11.901.jar, /home/code/antlr4-runtime-4.8.jar, /home/code/jackson-core-asl-1.9.13.jar, /home/code/wildfly-openssl-1.0.7.Final.jar')
# conf.set("spark.jars", '/home/code/hadoop-aws-3.3.1.jar, /home/code/delta-core_2.12-2.1.0.jar, /home/code/delta-storage-2.1.0.jar')
# conf.set("spark.jars", '/opt/bitnami/spark/jars/hadoop-aws-3.3.1.jar, /opt/bitnami/spark/jars/delta-core_2.12-2.1.0.jar')
